...
layer.config({
    extend: ["/layer.ext.js", "../css/style.css"],
    skin: "layer-ext-moon"
 ...
 /*   if ($.get("skin-config.html", function (a) {
    ...
    if(true)
    {
        var a = localStorage.getItem("collapse_menu"), e = localStorage.getItem("fixednavbar"), i = localStorage.getItem("boxedlayout"), l = $("body");
