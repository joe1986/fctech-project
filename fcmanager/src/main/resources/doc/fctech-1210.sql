/*
 ...
 Source Database       : fctech_new

 Target Server Type    : MySQL
 Target Server Version : 50625
 File Encoding         : utf-8

 Date: 12/08/2015 21:35:55 PM
*/
...
CREATE TABLE `T_BASE_PROJECT_ALLO_READER` (
  `project_readerid` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
BEGIN;
INSERT INTO `T_BASE_ROLE` VALUES ('0521202b43ef4c97bee97adbeff1da52', '银联业务运维用户角色', '', '2015-03-11 10:58:37', '2015-03-11 10:58:37', '0', '9358865eeab4439481616716df3b9826', '1', '', '1', '4', '0', '0'), ('18792b26423b45faa02790fb2cecf1ad', '银联技术运维管理员角色', '', '2015-03-11 10:55:22', '2015-03-11 10:55:22', '0', '9358865eeab4439481616716df3b9826', '1', '', '1', '5', '0', '0'), ('51e608eafe16497c8cf437a7a84aa692', '银联业务运维管理员角色', '', '2015-03-11 10:05:57', '2015-03-11 10:05:57', '0', '9358865eeab4439481616716df3b9826', '1', '', '1', '1', '0', '0'), ('b55260ecdcdd4eef99cf5f92202f4c79', '银联银行运维管理员角色', '', '2015-03-11 10:58:08', '2015-03-11 10:58:08', '0', '9358865eeab4439481616716df3b9826', '1', '', '1', '3', '0', '0'), ('d26fcc6af87b48869cdfbd314d3a25ad', '银联企业运维管理员角色', '', '2015-03-11 10:57:52', '2015-03-11 10:57:52', '0', '9358865eeab4439481616716df3b9826', '1', '', '1', '2', '0', '0'), ('daec1b13c9d04b28b46db599fc93f592', '银联技术运维用户角色', '', '2015-03-11 10:56:07', '2015-03-11 10:56:07', '0', '9358865eeab4439481616716df3b9826', '1', '', '1', '6', '0', '0');
COMMIT;
...
-- ----------------------------
--  Table structure for `T_BUSINESS_INCLI_LIMIT`
-- ----------------------------
DROP TABLE IF EXISTS `T_BUSINESS_INCLI_LIMIT`;
CREATE TABLE `T_BUSINESS_INCLI_LIMIT` (
  `limit_id` int(8) NOT NULL,
  `alarm_max` double DEFAULT NULL,
  `alarm_min` double DEFAULT NULL,
  `station_id` int(8) NOT NULL,
  `time` datetime DEFAULT NULL,
  PRIMARY KEY (`limit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='测斜报警值表';
...
-- ----------------------------
--  Table structure for `T_BUSINESS_SENSOR_INITDATA`
-- ----------------------------
DROP TABLE IF EXISTS `T_BUSINESS_SENSOR_INITDATA`;
CREATE TABLE `T_BUSINESS_SENSOR_INITDATA` (
...
-- ----------------------------
--  Table structure for `T_BUSINESS_SENSOR_REG`
-- ----------------------------
DROP TABLE IF EXISTS `T_BUSINESS_SENSOR_REG`;
CREATE TABLE `T_BUSINESS_SENSOR_REG` (
...
-- ----------------------------
--  Table structure for `T_BUSINESS_STATION_STARINLIMIT`
-- ----------------------------
DROP TABLE IF EXISTS `T_BUSINESS_STATION_STARINLIMIT`;
CREATE TABLE `T_BUSINESS_STATION_STARINLIMIT` (
  `limit_id` int(8) NOT NULL AUTO_INCREMENT,
  `alarm_max` double DEFAULT NULL COMMENT '报警上限',
  `alarm_min` double DEFAULT NULL COMMENT '报警下限',
  `station_id` int(8) NOT NULL,
  `type` varchar(10) DEFAULT NULL,
  `time` datetime DEFAULT NULL,
  PRIMARY KEY (`limit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='应变报警值表';

-- ----------------------------
--  Table structure for `T_BUSINESS_STATION_STRAINDATA`
-- ----------------------------
DROP TABLE IF EXISTS `T_BUSINESS_STATION_STRAINDATA`;
CREATE TABLE `T_BUSINESS_STATION_STRAINDATA` (
  ...
  `BendForce` double DEFAULT NULL COMMENT '弯曲力',
