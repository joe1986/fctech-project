            ...
            <ul class="nav" id="side-menu" style="display: block;">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src='<c:url value="resources/img/profile_small.jpg"></c:url>' /></span>
                ...
                <li class="">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                        <li>
                            <a class="J_menuItem" href="http://www.baidu.com" data-index="0">公司管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="http://www.tmall.com" data-index="5">项目管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="http://www.tencent.com/" data-index="6">用户管理</a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                        <li>
                            <a class="J_menuItem" href="http://www.baidu.com" data-index="0">菜单管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="http://www.tmall.com" data-index="5">角色管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="http://www.tencent.com/" data-index="6">角色菜单配置</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="http://www.tencent.com/" data-index="6">用户角色配置</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                        <li>
                            <a class="J_menuItem" href="http://www.baidu.com" data-index="0">信息采集</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="http://www.tmall.com" data-index="5">项目管理</a>
                        </li>
