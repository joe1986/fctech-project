...
public interface OperLogPOMapper {
	...
	int updateByExampleSelective(@Param("record") OperLogPOWithBLOBs record,
			@Param("example") OperLogPOExample example);

	int updateByExampleWithBLOBs(@Param("record") OperLogPOWithBLOBs record,
			@Param("example") OperLogPOExample example);

	int updateByExample(@Param("record") OperLogPO record,
			@Param("example") OperLogPOExample example);
